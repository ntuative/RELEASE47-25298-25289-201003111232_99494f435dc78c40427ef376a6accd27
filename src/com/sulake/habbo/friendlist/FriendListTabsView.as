package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_312);
         }
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         var_21.width = _friendList.tabs.tabContentWidth;
         var_21.findChildByName("bg").width = _friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in _friendList.tabs.getTabs())
         {
            _loc4_ = var_21.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         var_21.height = _loc2_ + 1;
         var_21.findChildByName("bg").height = var_21.height;
