package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         var_549 = main.component.userRegistry.getRegistry();
         if(false)
         {
            main.showUI(HabboHelpViewEnum.const_156);
         ...
         var i:int = 0;
         while(i < var_549.length)
         {
            u = var_549.getWithIndex(i);
      ...
      {
         var _loc3_:IWindowContainer = method_1("report_user_pick_user_item") as IWindowContainer;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      override public function render() : void
      {
         ...
         container = method_1("report_user_pick_user") as IWindowContainer;
         update();
         if(container == null)
         {
            return;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > var_549.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = var_549.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
