package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1115:int = 30;
      
      private static const const_1052:int = 253;
      ...
      override public function render() : void
      {
         ...
         {
            container = method_1("report_user_send") as IWindowContainer;
         }
         else
         {
            container = method_1("help_cfh_send") as IWindowContainer;
         }
         if(container == null)
         {
            return;
