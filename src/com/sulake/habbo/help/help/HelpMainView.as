package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends SearchViewController implements IHelpViewController
   {
      ...
      private static const const_1027:int = 60;
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_browse":
               main.showUI(HabboHelpViewEnum.const_368);
               break;
            case "help_habboway":
            ...
            case "help_cfh":
               ...
               main.showUI(HabboHelpViewEnum.const_325);
               break;
            case "help_report_user":
               main.component.callForHelpData.reportedUserId = 0;
               main.showUI(HabboHelpViewEnum.const_699);
            case "item_bg":
      ...
      {
         var _loc4_:IWindowContainer = method_1(param2) as IWindowContainer;
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      {
         var _loc3_:* = null;
         container = method_1("help_front_page") as IWindowContainer;
         if(container == null)
         {
            return;
         }
         ...
         if(_loc1_ == null || _loc1_.getFrontPageUrgentCategory().getAgeSeconds() > const_1027)
         {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            main.showUI(HabboHelpViewEnum.const_227);
            main.tellUI(HabboHelpViewEnum.const_227,_loc6_);
         }
      }
   }
}
