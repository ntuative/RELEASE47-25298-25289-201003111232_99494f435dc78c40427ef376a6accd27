package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(var_234 != null)
               {
                  ...
                  main.tellUI(HabboHelpViewEnum.const_253,_loc3_);
               }
               break;
            case "help_faq_next_entry":
               if(getNextItem() != null)
               {
                  main.tellUI(HabboHelpViewEnum.const_227,getNextItem());
               }
               break;
            default:
      ...
      override public function render() : void
      {
         ...
         container = method_1("help_faq_entry") as IWindowContainer;
         if(container == null)
         {
            return;
         }
