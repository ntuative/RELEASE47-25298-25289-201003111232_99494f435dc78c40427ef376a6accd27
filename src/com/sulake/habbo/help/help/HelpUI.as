package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1408:int = 0;
      ...
      private var var_1800:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25298-25289-201003111157");
         var_190 = param5;
         var_103 = new Map();
         var_103.add(HabboHelpViewEnum.const_1208,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_156,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_368,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_253,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_227,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_661,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_325,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_677,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_228,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_103.add(HabboHelpViewEnum.const_1002,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_699,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_254 == HabboHelpViewEnum.const_156 || false)
         {
            return;
         }
         if(var_393 == null)
      ...
      {
         return var_103.getValue(var_254);
      }
      ...
      {
         var_1799 = param1;
         var _loc2_:IHelpViewController = var_103.getValue(HabboHelpViewEnum.const_156) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_957:
               showUI(HabboHelpViewEnum.const_1002);
               break;
            case CallForHelpResultEnum.const_868:
      ...
      {
         var _loc3_:* = null;
         if(var_254 == HabboHelpViewEnum.const_156)
         {
            return;
         }
         if(true)
         {
            ...
            var_557.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_557[1],var_557[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_557[0],var_557[0].rect,new Point(0,0));
         }
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_254);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_190 != null)
            {
               var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_24.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_634));
      }
