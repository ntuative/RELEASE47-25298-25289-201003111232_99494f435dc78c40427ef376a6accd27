package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseTopView extends SearchViewController implements IHelpViewController
   {
      ...
      {
         var _loc3_:IWindowContainer = method_1("help_itemlist_item") as IWindowContainer;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      override public function render() : void
      {
         ...
         disposed = false;
         container = method_1("help_faq_categories") as IWindowContainer;
         if(container == null)
         {
            return;
         }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         main.showUI(HabboHelpViewEnum.const_253);
         main.tellUI(HabboHelpViewEnum.const_253,_loc5_);
      }
   }
}
