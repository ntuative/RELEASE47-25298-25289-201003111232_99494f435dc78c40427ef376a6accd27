package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_470:Point = null;
      
      private var var_659:Map = null;
      ...
      {
         return [RoomSessionChatEvent.const_151];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_472 != null)
         {
            ...
            {
               _loc2_ = var_472.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_151:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_472.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_659.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_336:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_104);
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_39).clone();
                                          _loc17_ = _loc16_.getPartColor("pbd");
                                       }
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_104);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_472.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_659.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_724,RoomWidgetChatSelectAvatarMessage.const_645];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_724:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_151,_container.roomSession,0,"Version 25298-25289-201003111157");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_645:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_798 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_798);
            }
            if(var_470 == null)
            {
               var_471.x = 0;
               var_471.y = 0;
               var_471.z = 0;
               var_470 = _loc4_.getScreenPoint(var_471);
               var_798 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_471.x = 0;
            var_471.y = 0;
            var_471.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_471);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_470.x || _loc8_.y != var_470.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_470,_loc5_));
