package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_541:String = "InitConnection";
      ...
      private var var_358:HabboCommunicationDemo;
      ...
      {
         var_358.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_358.shockwaveClientUrl = var_114.shockwaveClientUrl;
         var_358.ssoTicket = var_114.ticket;
         var_114.removeEventListener(SSOTicket.const_281,onParsedTicketSuccess);
         var_114.removeEventListener(SSOTicket.const_249,onParsedTicketFailure);
         var_114 = null;
         dispatchEvent(new Event(const_541));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1411,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_358 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_358.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_397,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_358.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_90,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1411,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_358.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_358.habboCommunication.habboWebLogin(name,password);
         var_114 = new SSOTicket(var_358.assets,_loc2_,_loc1_);
         var_114.addEventListener(SSOTicket.const_281,onParsedTicketSuccess);
         var_114.addEventListener(SSOTicket.const_249,onParsedTicketFailure);
      }
