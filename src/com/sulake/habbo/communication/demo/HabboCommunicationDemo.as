package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_174:HabboHotelView;
      ...
      private var var_2080:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1534:ILogger;
      
      private var var_1281:String;
      
      private var var_2079:String;
      
      private const const_1411:String = "fuselogin";
      
      private var var_306:ICoreCommunicationManager;
      
      private var var_409:IKeyExchange;
      ...
      private var var_72:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1046)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_169);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_331:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_996:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_837:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_869:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2078)
         {
      ...
      {
         var_1046 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_207);
         param1.send(new VersionCheckMessageComposer(401,var_1281,var_2079));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1411,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_409.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_409.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2080);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1411,"/");
      ...
      {
         var_702 = _habboConfiguration.getKey("sso.ticket",null);
         var_1281 = _habboConfiguration.getKey("flash.client.url","");
         var_2079 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_174 == null)
         {
            var_174 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_702 != null)
         {
            var_72.mode = HabboConnectionType.const_478;
            var_72.initConnection(HabboConnectionType.const_270);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1534 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_72 = param2 as IHabboCommunicationManager;
            _loc3_ = var_72.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_72.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_72.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_72.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_72.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_72.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_72.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_72.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_72.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_72.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_72.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_72.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_72.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_72.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_560);
            _loc3_ = new InitCryptoMessageComposer(var_72.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2080 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_72.mode)
         {
            case HabboConnectionType.const_478:
               _loc6_ = "";
               ...
               var_1047 = _loc4_;
               var_174.loadBannerImage(_loc7_ + "?token=" + var_1047,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1211:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1170:
               var_701 = generateRandomHexString(30);
               var_409 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_409.init(var_701);
               _loc8_ = var_409.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_174.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1047);
         ...
         var _loc9_:IConnection = var_72.getHabboMainConnection(null);
         ...
         var_409 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_409.init(_loc14_);
            _loc15_ = var_409.getPublicKey(10);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_210);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_163,onConfigurationLoaded);
         }
      }
