package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_306.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_35)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_906,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_176,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_171,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_46,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_380,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_605,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_878,onHideWindowEvent);
         var_35 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_85));
      }
