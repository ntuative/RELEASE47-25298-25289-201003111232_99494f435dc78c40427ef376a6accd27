package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1119:Number = 90;
      
      private static const const_742:int = 50;
      
      private static const const_1028:Number = 25;
      ...
      private var var_951:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_454.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_454.splice(_loc3_,1);
            var_453.splice(_loc3_,1);
         }
         var_453.push(param1.name);
         var_454.push(param2);
         param1.addEventListener(WindowEvent.const_413,windowEventListener);
         param1.addEventListener(WindowEvent.const_231,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_454[var_453.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_951.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_289.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_289.splice(var_289.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_951.getIconLoc(param1.iconId);
      ...
      {
         return var_453[var_454.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_289[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_742 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_742 || param1.desktop.height - param1.y < const_1029;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_453[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
