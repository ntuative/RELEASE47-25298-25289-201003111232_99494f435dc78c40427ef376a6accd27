package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_741:String = "selection_arrow";
      
      private static const const_740:String = "tile_cursor";
      
      private static const const_277:String = "RCL_PUBLICROOM_";
      
      private static const const_484:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_341:String = "place_holder";
      
      private static const const_1026:String = const_341;
      
      private static const const_1397:int = 0;
      
      private static const const_739:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_576:String = "RCL_LOADER_READY";
      ...
      private var var_944:IEventDispatcher = null;
      
      private var var_1115:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_447 = [];
         var_448 = [];
         var_1620 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1624 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_375 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_31:
                     if(var_447.indexOf(_loc4_) == -1)
                     {
                        var_447.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_30:
                     if(var_448.indexOf(_loc4_) == -1)
                     {
                        var_448.push(_loc4_);
                     }
                     break;
      ...
      {
         if(var_164 != null && var_164.hasWorldType(const_277 + param1))
         {
            return var_164.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_446.add(_loc10_,_loc11_);
                              if(var_447.indexOf(_loc14_) < 0)
                              {
                                 var_447.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_448.indexOf(_loc14_) < 0)
                              {
                                 var_448.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_327 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_327.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_535.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_341,const_484,ROOM_CONTENT,const_740,const_741];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1620.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_159 && _loc5_ != RoomObjectLogicEnum.const_126)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_446.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_447.indexOf(param1) >= 0)
         {
            return const_341;
         }
         if(var_448.indexOf(param1) >= 0)
         {
            return const_484;
         }
      ...
      {
         if(var_534.getValue(param1) != null)
         {
            return var_534.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1370);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_394,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_1623)
         {
            ...
            if(var_944 != null)
            {
               var_944.dispatchEvent(new Event(const_576));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_164 != null)
         {
            return var_164.getWorldHeightScale(const_277 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_33,furniDataLoadedHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_45,furniDataLoadedHandler);
            var_944 = param1;
            var_1621 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1619 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1622 = param2.getKey("public.room.dynamic.download.url","");
            var_1618 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_35 = const_739;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_327.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_374 != null)
         {
            var_374.remove(param1);
            var_374.add(param1,param2);
         }
         if(var_376 != null)
         {
            var_376.remove(param2);
            var_376.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_159 && _loc5_ != RoomObjectVisualizationEnum.const_126)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_403.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_327.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1115.getValue(param1) != null)
         {
            var_164 = var_1115.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_164 != null)
         {
            return var_164.getWorldScale(const_277 + param1);
         }
         return 32;
      }
