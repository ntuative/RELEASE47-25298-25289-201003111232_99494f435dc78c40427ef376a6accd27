package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1393:Number = Math.sqrt(0.5);
      ...
      protected var var_1580:String = null;
      ...
      protected var var_2264:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_590[param1] = _loc3_;
            var_589[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1580 != null && var_1580.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      {
         var _loc3_:int = 0;
         if(var_2095 != param1 || var_2096 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_590[_loc3_] = "";
               var_589[_loc3_] = false;
               _loc3_--;
            }
            var_2095 = param1;
            var_2096 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2094 != param1 || var_2093 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2278 = _loc3_.getNumber(RoomObjectVariableEnum.const_216);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_193));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1580 = _loc3_.getString(RoomObjectVariableEnum.const_308);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_288 != _loc3_.getUpdateID() || param1 != var_208 || param2 != var_2264)
         {
