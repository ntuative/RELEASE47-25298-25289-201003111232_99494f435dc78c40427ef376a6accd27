package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_764:int = 15;
      
      private static const const_1070:int = 2;
      
      private static const const_345:int = 2;
      
      private static const const_763:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1011[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1010[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1011 = new Array();
         var_1011.push(Math.random() * _loc2_ * 1.5);
         var_1011.push(Math.random() * _loc2_ * 1.5);
         var_1009 = new Array();
         var_1009.push(1);
         var_1009.push(-1);
         var_1008 = new Array();
         var_1008.push(const_1070);
         var_1008.push(const_1071);
         var_1010 = new Array();
         var_1010.push(getRandomAmplitudeFactor());
         var_1010.push(getRandomAmplitudeFactor());
      }
