package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_737:String = "default";
      ...
      private var var_879:IGraphicAssetCollection = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = var_879.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_163.getValue(_loc6_) == null)
               {
      ...
      {
         return var_298.getValue(param1) as PlaneMaterial;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_101 != null)
         {
            ...
            {
               _loc2_ = var_101.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetMaterials() : void
      {
         ...
         {
            _loc2_ = var_298.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return var_163.getValue(param1) as PlaneTexture;
      }
      
      protected function getPlane(param1:String) : Plane
      {
         return var_101.getValue(param1);
      }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = var_163.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(var_101.getValue(param1) == null)
         {
            var_101.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < var_298.length)
         {
            _loc3_ = var_298.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
