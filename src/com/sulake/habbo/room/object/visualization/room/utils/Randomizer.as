package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1556:int = 16777216;
      
      public static const const_1512:int = 1;
       
      
      private var var_2348:int = 69069;
      
      private var var_1338:int = 1;
      
      private var var_2349:int = 5;
      
      private var var_1570:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1570 * param2);
      }
      ...
      {
         var _loc1_:int = var_2348 * var_1338 + var_2349;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
