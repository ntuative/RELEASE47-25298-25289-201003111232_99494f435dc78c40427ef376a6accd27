package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1384:int = const_294;
      ...
      public static const ALIGN_DEFAULT:int = const_99;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_360[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      {
         if(param1 == null || var_25 == null || param1 == var_25)
         {
            return;
         }
         if(!param4)
         ...
         var _loc5_:* = null;
         if(var_1558 == const_99)
         {
            _loc5_ = new Rectangle(0,0,var_25.width,var_359);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_359,var_25.width,var_359);
         }
         param1.copyPixels(var_25,_loc5_,new Point(0,param3),null,null,true);
      }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_25 != null)
            {
               if(var_25.width == param2 && var_25.height == param3 && Vector3d.isEqual(var_561,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_359,param6,param7);
                     return param1;
                  }
                  return var_25;
               }
         ...
         {
            if(var_25.width == param2 && var_25.height == param3)
            {
               var_25.fillRect(var_25.rect,16777215);
            }
            else
            {
               var_25.dispose();
         ...
         var_1190 = true;
         var_561.assign(param4);
         if(!param5)
         {
            var_359 = param3;
            if(var_25 == null)
            {
               var_25 = new BitmapData(param2,param3,true,4294967295);
            }
            else
            {
               var_25.fillRect(var_25.rect,4294967295);
            }
            if(param1 != null)
            {
         ...
         {
            var_359 = param3;
            var_25 = new BitmapData(param2,param3,true,16777215);
         }
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_360.length)
         {
            _loc11_ = var_360[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
         ...
         {
            case const_224:
               _loc10_ = renderRepeatBorders(var_25,_loc8_);
               break;
            case const_192:
               _loc10_ = renderRepeatCenter(var_25,_loc8_);
               break;
            case const_203:
               _loc10_ = renderRepeatFirst(var_25,_loc8_);
               break;
            case REPEAT_MODE_LAST:
               _loc10_ = renderRepeatLast(var_25,_loc8_);
               break;
            case const_610:
               _loc10_ = renderRepeatRandom(var_25,_loc8_);
               break;
            default:
               _loc10_ = renderRepeatAll(var_25,_loc8_);
         }
         var_359 = _loc10_;
         if(param1 != null)
         {
      ...
      public function clearCache() : void
      {
         ...
         if(var_561 != null)
         {
            var_561.assign(new Vector3d());
         }
         var_359 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_360.length)
         {
            _loc2_ = var_360[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_360.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_360[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_360[param1] = _loc5_;
