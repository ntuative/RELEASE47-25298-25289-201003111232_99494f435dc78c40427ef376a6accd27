package com.sulake.habbo.session.handler
{
   ...
   public class VoteHandler extends BaseHandler
   {
      ...
      private function onVoteQuestionEvent(param1:VoteQuestionMessageEvent) : void
      {
         ...
         var _loc2_:IRoomSession = listener.getSession(_xxxRoomId,var_37);
         if(_loc2_ == null)
         {
            return;
         }
         var _loc3_:VoteQuestionMessageParser = param1.getParser();
         _loc4_ = new RoomSessionVoteEvent(RoomSessionVoteEvent.const_117,_loc2_,_loc3_.question,_loc3_.choices);
      ...
      private function onVoteResultEvent(param1:VoteResultMessageEvent) : void
      {
         ...
         _loc4_ = new RoomSessionVoteEvent(RoomSessionVoteEvent.const_129,_loc2_,_loc3_.question,_loc3_.choices,_loc3_.votes,_loc3_.totalVotes);
         listener.events.dispatchEvent(_loc4_);
      }
   }
}
