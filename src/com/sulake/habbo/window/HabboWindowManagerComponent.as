package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1163:ProfilerAgentTask;
      
      private var var_1166:IEventDispatcher;
      
      private var var_2356:uint = 0;
      
      private var var_1165:ProfilerAgentTask;
      
      private var var_1164:ProfilerOutput;
      
      private var var_645:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1166 = Component(param1).events;
         var_385 = new Array();
      ...
      {
         return var_214[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_214[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_645 = new WindowRenderer(_loc4_);
         var_214 = new Array(const_343);
         var _loc6_:int = 0;
         while(_loc6_ < const_343)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_645,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_214[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_236 = var_214[const_1047];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_236.getMouseCursor().defineCustomCursorType(MouseCursorType.const_332,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_236.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1268,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_214[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_214.pop()).dispose();
            }
            var_214 = null;
            while(false)
            {
      ...
      {
         return var_214[param1].getDesktopWindow().getChildAt(var_236.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1164 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1164 = new ProfilerOutput(_loc3_,this,var_645);
               var_1163 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1163);
               var_1165 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1165);
               var_970 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_925.length > 0)
         {
            var_1166.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_343 - 1;
            while(_loc2_ >= 0)
            {
               var_214[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_970)
         ...
         var_1166.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_343)
         {
            var_214[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_970)
         {
         ...
         if(WindowContext.var_925.length > 0)
         {
            WindowContext.var_925.flush();
         }
         if(WindowContext.var_1365.length > 0)
         {
            WindowContext.var_1365.flush();
         }
         var_1166.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_385[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_385[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1293,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1265,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1286,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1272,param2.name + ": " + param2.toString());
            }
         }
      }
   }
