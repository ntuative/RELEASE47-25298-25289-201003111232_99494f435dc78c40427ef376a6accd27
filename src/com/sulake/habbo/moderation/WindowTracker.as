package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_689:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1136:int = 7;
      
      public static const const_813:int = 3;
      
      public static const const_1146:int = 8;
      
      public static const const_900:int = 5;
      ...
      {
         var _loc2_:Dictionary = var_1509[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1509[param1] = _loc2_;
         }
         return _loc2_;
      }
