package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_460:Matrix4x4;
      
      private var var_769:Vector3D;
      
      private var var_124:Dictionary;
      
      private var var_639:Dictionary;
      
      private var var_1400:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_769 = new Vector3D(0,0,10,0);
         super();
         var_460 = new Matrix4x4();
         var_639 = new Dictionary();
         var_1400 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            var_639[String(_loc4_.@id)] = _loc12_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_460 = var_460.identity().rotateY(param3);
            return _loc5_.getParts(var_460,var_769,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1400.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_639[param1] as Dictionary;
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_460 = var_460.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_460);
            _loc11_ = _loc8_.getDistance(var_769);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_639[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1400.findAvatarSet(param1);
         if(_loc3_ != null)
         {
