package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_477:IBitmapWrapperWindow;
      
      private var _window:IWindowContainer;
      
      private var var_1168:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1168 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_477 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_477.bitmap = new BitmapData(var_477.width,var_477.height,true,16777215);
         var_477.bitmap.copyPixels(var_1168,var_1168.rect,new Point(0,0 - 0 - 8));
         var_477.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
