package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_704:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_872.width,var_872.height,true,0);
            _loc4_ = var_872.clone();
            _loc4_.colorTransform(_loc4_.rect,var_704.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_703.width,var_703.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_703,var_703.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(false)
               {
                  _loc5_.bitmap.copyPixels(var_1048,var_1048.rect,new Point(0,0),null,null,true);
               }
               else
               {
                  _loc5_.bitmap.copyPixels(var_1049,var_1049.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }
