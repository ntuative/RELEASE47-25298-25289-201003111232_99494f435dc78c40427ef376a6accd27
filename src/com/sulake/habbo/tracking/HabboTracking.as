package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_252:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_130:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1023:int = -1;
      
      private var var_836:LagWarningLogger = null;
      
      private var var_837:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_836 = new LagWarningLogger();
         var_1236 = new Array(const_765);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1201,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1287,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1360,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_599,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_903,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_560:
               trackLoginStep(HabboLoginTrackingStep.const_1261,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_207:
               trackLoginStep(HabboLoginTrackingStep.const_207);
               break;
            case HabboCommunicationEvent.const_169:
               trackLoginStep(HabboLoginTrackingStep.const_169);
               break;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_155)
         {
            Component(var_155).events.addEventListener(HabboConfigurationEvent.const_163,onConfigurationLoaded);
            if(var_225 != null)
            {
               var_225.configuration = var_155;
            }
            if(var_226 != null)
            {
               var_226.configuration = var_155;
            }
            if(var_836 != null)
            {
               var_836.configure(var_155);
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_252.events.addEventListener(AdEvent.const_459,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1962)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1148);
            var_1962 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_903,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_560,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_169,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_210,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_535,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_63,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_388,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_401:
               var_836.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_837)
            {
               var_837.release(new IIDHabboWindowManager());
               var_837 = null;
            }
            if(var_252)
            {
            ...
            if(var_170)
            {
               if(true)
               {
                  ...
                  Component(var_170).events.removeEventListener(HabboFriendListTrackingEvent.const_312,onFriendlistTrackingEvent);
               }
            ...
            if(var_130)
            {
               if(true)
               {
                  var_130.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_130.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_130.release(new IIDHabboHelp());
               var_130 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_401,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_163);
         if(var_155)
         {
            Component(var_155).events.removeEventListener(HabboConfigurationEvent.const_163,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_94);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_94,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_130 = param2 as IHabboHelp;
         var_130.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_130.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_879);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_879,onCoreRunning);
         }
      }
      ...
      {
         var_837 = IHabboWindowManager(param2);
         if(var_837)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1023 > -1 && _loc2_ < var_1023)
         {
            ++var_1493;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1493);
         }
         if(var_1023 > -1 && _loc2_ - var_1023 > 15000)
         {
            ++var_1492;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1492);
         }
         var_1023 = _loc2_;
         if(var_226 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_401,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_254,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_170).events.addEventListener(HabboFriendListTrackingEvent.const_312,onFriendlistTrackingEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_94,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_535)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1252);
         }
         else if(param1.type == HabboHotelViewEvent.const_388)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1141);
         }
         else if(param1.type == HabboHotelViewEvent.const_63)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1371);
         }
      }
   }
}
