package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1473:CutToHeight = new CutToHeight();
      
      private static var var_1472:CutToWidth = new CutToWidth();
      ...
      {
         var _loc4_:IWindow = param1.findChildByName(param2);
         _loc4_.setParamFlag(HabboWindowParam.const_40,true);
      ...
      public static function method_2(param1:IWindow, param2:Function) : void
      {
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1473.beforeSearch(param2,param1,param3);
         binarySearch(var_1473,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1472.beforeSearch(param2,param1,param3);
         binarySearch(var_1472,param2.length - 1);
      }
   }
}
