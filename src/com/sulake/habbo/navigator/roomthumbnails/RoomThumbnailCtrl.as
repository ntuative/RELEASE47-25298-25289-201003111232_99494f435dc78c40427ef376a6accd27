package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1465,this._model.mode != ThumbnailEditorModel.const_55);
         setEnabled(var_1464,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_55;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1465 = IButtonWindow(find("top_tab"));
         var_1464 = IButtonWindow(find("obj_tab"));
         var_1880 = IWindowContainer(find("tile_grid"));
         var_1879 = IWindowContainer(find("now_editing_container"));
         Util.method_2(find("save"),onSaveButton);
         Util.method_2(find("cancel"),onCancelButton);
         Util.method_2(_bgTabButton,onBgTabButton);
         Util.method_2(var_1465,onTopTabButton);
         Util.method_2(var_1464,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1880;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_425)
            {
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_34;
         this.reload();
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = var_1879;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_58,HabboWindowStyle.const_38,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_41,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),onImgSel,_loc10_.id));
      ...
      private function refreshImgSelectors() : void
      {
         ...
         refreshImgSelector(ThumbnailEditorModel.const_55);
