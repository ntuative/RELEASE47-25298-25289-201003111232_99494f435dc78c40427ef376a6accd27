   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_866 = _window.findChildByName("effect_hilite");
            var_866.visible = false;
         }
         var_864 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_865 = _window.findChildByName("loader_bar");
         if(var_865 != null)
         {
            var_431 = var_865.width;
            var_166.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_864 != null)
         {
            var_864.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_864.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
