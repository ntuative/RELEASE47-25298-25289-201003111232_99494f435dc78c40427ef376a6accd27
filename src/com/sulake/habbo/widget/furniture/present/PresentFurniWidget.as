package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_391,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_475,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_365,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_367,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_391,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_475,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_365,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_367,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_475:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_365:
               if(!var_221)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_367:
               if(!var_221)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_391:
               if(!var_221)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_595,var_151);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_58,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1051,const_1054,2,2),null,0) as IWindowContainer;
