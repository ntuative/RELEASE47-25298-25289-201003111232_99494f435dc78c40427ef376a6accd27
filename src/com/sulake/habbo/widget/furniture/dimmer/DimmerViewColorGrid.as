package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_473:BitmapData;
      
      private var var_1195:XML;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_394.destroyGridItems();
         var_308 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1195) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_473.width;
            _loc3_.height = var_473.height;
            var_394.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_473.width,var_473.height,true,0);
               _loc4_.bitmap.copyPixels(var_473,var_473.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_801.width,var_801.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_666.width,var_666.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_666,var_666.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_394.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_394.numGridItems)
         {
            return;
         }
         select(var_394.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_308 != null)
         {
            _loc2_ = var_308.getChildByName("chosen");
            if(_loc2_ != null)
            {
