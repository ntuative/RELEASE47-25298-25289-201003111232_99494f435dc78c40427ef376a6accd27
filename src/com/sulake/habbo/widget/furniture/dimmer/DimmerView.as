package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1051:Number = 100;
      
      private static const const_1054:Number = 100;
       
      
      private var var_1349:XML;
      
      private var var_379:int;
      
      private var var_521:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2232:int;
      
      private var var_364:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_223.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_223.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_58,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1051,const_1054,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_521 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_364 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_223 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_223.numTabItems)
         {
            _loc6_ = var_223.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_40,true);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_521 != null)
         {
            var_521.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_223.selector.getSelected();
         return var_223.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_364 != null)
         {
            var_364.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_364 != null)
         {
            var_364.setValue(var_1083);
         }
         var_379 = colors.indexOf(_loc2_.color);
         if(var_521 != null)
         {
            var_521.setSelectedColorIndex(var_379);
         }
