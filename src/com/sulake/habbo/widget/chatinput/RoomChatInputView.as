package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1413:int = 5;
      
      private static const const_485:int = 16;
      ...
      private var var_431:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1056 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2108 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2109 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_707 = new Timer(1000,1);
         var_707.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_878 = new Timer(5000,1);
         var_878.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_58,HabboWindowStyle.const_41,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_155,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_413,onWindowMoved);
         var_1291 = true;
         var_135 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2110 = _loc2_.width + const_485 + _loc6_.width + const_1088;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1087,_loc8_.width) + const_485);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1056 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_135 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_431);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_431);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_49,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_508);
