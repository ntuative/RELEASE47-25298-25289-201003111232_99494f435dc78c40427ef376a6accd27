package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_710[var_1060] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_309)
         {
            ...
            var_309 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_309.center();
            var_309.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1060;
         if(var_1060 < var_710.length)
         {
            _loc1_ = var_710[var_1060] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_710.length);
                  _loc2_.text = _loc6_;
               }
