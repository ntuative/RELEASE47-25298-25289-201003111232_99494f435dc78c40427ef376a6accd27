package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_739:Array = null;
      ...
      private var var_1265:int = 30000;
      
      private var var_1263:Boolean = false;
      
      private var var_943:Array = null;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1265 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_117,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_129,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_318,update);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1752;
         if(_loc2_ > var_1265)
         {
            vote();
            return;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_117,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_129,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_318,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1265 - param1) / 1000,0);
