package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         super();
         var_123 = param1;
         var_21 = IWindowContainer(param2.findChildByName("content"));
         var_775 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_21.findChildByName("convo_bg"));
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_180 ? var_123.conversations.findConversation(param2.id) : var_123.conversations.openConversations[_loc3_ + var_123.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboMessenger.const_180) as IBitmapWrapperWindow;
      ...
      {
         var _loc3_:IWindowContainer = var_775.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
         refreshArrow(_loc3_,param1,param2);
         refreshTabBg(_loc3_,param1,!!param2 ? "tab_bg_next" : "tab_bg_unsel");
         var _loc4_:int = 0 % var_1148;
         _loc3_.width = var_1148 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         _loc3_.x = param1 * var_1148;
         _loc3_.width = var_1148;
         return false;
      }
   }
}
