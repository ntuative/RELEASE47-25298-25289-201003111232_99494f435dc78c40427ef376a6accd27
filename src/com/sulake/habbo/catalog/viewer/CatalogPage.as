package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1394:String = "ctlg_";
      ...
      private var var_1296:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_824:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1394 + param1;
         ...
         var_1378 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1378) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1222) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1240) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1363) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1296;
            _loc2_.init();
         }
         var_1296.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1296.dispatchEvent(param1);
      }
