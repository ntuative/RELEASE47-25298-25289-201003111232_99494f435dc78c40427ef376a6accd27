package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_541[var_956] as Array;
      ...
      {
         var _loc2_:Offer = var_541[var_956][var_1672];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_418 || _loc1_.pricingModel == Offer.const_384)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_77 || _loc3_.productType == ProductTypeEnum.const_79)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_955.indexOf(_loc5_) == -1)
                        {
                           var_955.push(_loc5_);
                           var_541.push(new Array());
                        }
                        _loc6_ = var_955.indexOf(_loc5_);
                        (var_541[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_541)
         {
            if(var_1672 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1672] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_956 = var_936.getGridItemIndex(param1.view);
