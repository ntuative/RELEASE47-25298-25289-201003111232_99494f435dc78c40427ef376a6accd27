package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1404:Point;
      
      private var var_1720:Array;
      
      private var var_544:IItemGridWindow;
      
      private var var_81:IBitmapWrapperWindow;
      
      private var var_1314:ITextWindow;
      
      private var var_1154:IScrollbarWindow;
      
      protected var var_1379:XML;
      
      private var var_1155:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_544 != null)
         {
            var_544.visible = false;
            var_544.destroyGridItems();
         }
         if(var_1154 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1314.text = "${" + _loc3_.name + "}";
            var_1315.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1314.text = "${" + _loc2_.localizationId + "}";
            var_1315.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_470:
                  _loc4_ = var_1155.clone();
                  if(var_544 != null)
                  {
                     var_544.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_544,var_1154,var_1379);
                  }
                  break;
               ...
               case Offer.const_384:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_77:
                        ...
                        _loc2_.previewCallbackId = _loc7_.id;
                        break;
                     case ProductTypeEnum.const_201:
                        ...
                        _loc4_ = new BitmapData(var_81.width,var_81.height,false,_loc10_);
                        _loc11_ = null;
                        _loc12_ = page.viewer.catalog as HabboCatalog;
                        if(_loc12_.avatarRenderManager != null)
                        {
                           _loc14_ = _loc12_.sessionDataManager.figure;
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_52);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_47,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_299,AvatarAction.const_731);
                              _loc13_.appendAction(AvatarAction.const_556,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_39);
                        ...
                        break;
                     case ProductTypeEnum.const_481:
                        break;
                     default:
      ...
      {
         var_1314 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1315 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1404 = new Point(var_81.x,var_81.y);
         var_544 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1154 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_544 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1379 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1155 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_81);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_33,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_81 != null && true)
         {
            ...
            if(true)
            {
               var_81.bitmap = new BitmapData(var_81.width,var_81.height,true,16777215);
            }
            var_81.bitmap.fillRect(var_81.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_81.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_81.invalidate();
            var_81.x = var_1404.x;
            var_81.y = var_1404.y;
            if(param3 != null)
