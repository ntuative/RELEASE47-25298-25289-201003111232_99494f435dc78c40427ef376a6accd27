package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_936:IItemGridWindow;
      
      protected var var_1379:XML;
      
      private var var_1519:Map;
      
      private var var_855:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_936 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1379) as IWindowContainer;
         var_936.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1519.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_104);
         var _loc5_:IBitmapWrapperWindow = _loc2_.findChildByName("image") as IBitmapWrapperWindow;
         _loc5_.bitmap = new BitmapData(_loc5_.width,_loc5_.height,true,16777215);
         _loc4_.setDirection(AvatarSetType.const_39,4);
         var _loc6_:BitmapData = _loc4_.getImage(AvatarSetType.const_39);
      ...
      {
         var _loc1_:String = var_1519.getValue(var_855.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc2_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc1_,AvatarScaleType.const_52);
         _loc2_.setDirection(AvatarSetType.const_39,4);
         setPreviewImage(_loc2_.getImage(AvatarSetType.const_39));
         _loc2_.dispose();
      }
      
      private function onBuyButtonEvent(param1:WindowEvent) : void
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_855,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_855.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_855.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_855.localizationId);
