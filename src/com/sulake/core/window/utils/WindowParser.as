package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1527:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1500:String = "_TEMP";
      ...
      protected var var_1107:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_938:Dictionary;
      
      protected var var_1382:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1383:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1107 = new Dictionary();
         TypeCodeTable.fillTables(var_1108,var_1107);
         var_938 = new Dictionary();
         var_1383 = new Dictionary();
         ParamCodeTable.fillTables(var_938,var_1383);
         var_1382 = new Map();
      }
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1132,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1107)
            {
               delete var_1107[_loc1_];
            }
            for(_loc1_ in var_938)
            {
               delete var_938[_loc1_];
            }
            for(_loc1_ in var_1383)
            {
               delete var_1383[_loc1_];
            }
            var_1382.dispose();
            var_1382 = null;
            _context = null;
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_178)
                     {
                        window.y = rect.y;
                     }
                  }
