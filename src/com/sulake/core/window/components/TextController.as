package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_526:String = "none";
      
      protected var var_619:Number;
      
      protected var var_367:Number;
      ...
      private static function method_10(param1:TextController, param2:Boolean) : void
      {
      ...
      {
         return new Rectangle(var_619 * maxScrollH,var_367 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_750)
         {
            context.removeLocalizationListener(var_325,this);
         }
         if(var_66 != null)
         {
            var_66.dispose();
      ...
      {
         var_619 = param1;
         _field.scrollH = var_619 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_325 = param1;
         if(var_325.charAt(0) == "$" && var_325.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_325.slice(2,var_325.indexOf("}")),this);
            var_750 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_916,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_60,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_709,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_709,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_66.left,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("margin_top",var_66.top,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("margin_right",var_66.right,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_66.bottom,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("auto_size",var_526,PropertyStruct.STRING,var_526 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_709,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_619 = var_619;
         _loc1_.var_367 = var_367;
         _loc1_.var_66 = var_66.clone(_loc1_.setTextMargins);
         _loc1_.var_526 = var_526;
         _loc1_.var_750 = var_750;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_526 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_526 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_526 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_526 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
