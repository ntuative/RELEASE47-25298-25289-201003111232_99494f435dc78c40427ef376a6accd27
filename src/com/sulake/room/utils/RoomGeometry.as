package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_573:Number = 64;
      ...
      private var var_1422:Number = 1;
      
      private var var_77:int = 0;
      
      private var var_390:Map = null;
      
      private var var_976:Vector3d;
      ...
      private var var_1424:Number = 1;
      
      private var var_2339:Number = 500;
      
      private var var_1423:Number = 1;
      
      private var var_87:Vector3d;
      
      private var var_86:Vector3d;
      
      private var var_2340:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_86 = new Vector3d();
         var_976 = new Vector3d();
         var_1422 = 1;
         var_1423 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1424 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_215.assign(param1);
         if(var_215.x != _loc2_ || var_215.y != _loc3_ || var_215.z != _loc4_)
         {
            ++var_77;
         }
      ...
      {
         if(var_389 != param1 * var_1424)
         {
            var_389 = param1 * var_1424;
            ++var_77;
         }
      }
      ...
      {
         if(var_387 != param1 * var_1422)
         {
            var_387 = param1 * var_1422;
            ++var_77;
         }
      }
      ...
      {
         if(var_388 != param1 * var_1423)
         {
            var_388 = param1 * var_1423;
            ++var_77;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_390 != null)
         {
            ...
            var_390.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_390.add(_loc3_,_loc4_);
            ++var_77;
         }
      }
      ...
      {
         return new Vector3d(var_215.x,var_215.y,var_215.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_976.assign(_loc22_);
         }
         else
         {
            var_976.assign(_loc17_);
         }
         ++var_77;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_388;
         _loc2_.z *= var_389;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_976);
         if(_loc3_ < var_2340 || _loc3_ > var_2339)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_388;
            _loc2_.z *= var_389;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_976);
         }
      ...
      {
         return new Vector3d(0 * var_387,0 * var_388,0 * var_389);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_390 != null)
         {
            ...
            return var_390.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_387,0 * var_388,0 * var_389);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_387,param2.y * var_388,param2.z * var_389);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_387,param3.y * var_388,param3.z * var_389);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_387,param4.y * var_388,param4.z * var_389);
