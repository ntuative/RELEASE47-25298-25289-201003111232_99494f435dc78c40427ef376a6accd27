package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_519 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         return !true ? var_141[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_584))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_584,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_94 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_584,"EOF"));
            }
         }
      }
      ...
      {
         if(var_519.parse(param1))
         {
            var_48.push(var_519);
            if(false)
            {
               var_141["null"] = var_519;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1227,var_519));
            var_519 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_48 != null && var_141 != null && param1 < var_48.length)
         {
            _loc2_ = var_48[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_48.splice(param1,1);
               delete var_141[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
